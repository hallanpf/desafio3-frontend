    ...
    <div className="right">
      <nav>
          <ul>
            ...
            <li><Link to="/Cart"><img src="../src/assets/ant-design_shopping-cart-outlined.png" alt="Shopping Cart" /></Link></li>
        </ul>
      </nav>
    </div>
  </header>
  ...
  <section className="filter-content-section">
    <div className="left">
      <div className="filter-bar">
        ...
        <img src="../src/assets/system-uicons_filtering.png" alt="Filter Button" /></button>
